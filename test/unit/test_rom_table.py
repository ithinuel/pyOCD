...
class MockCoreForMemCache(CoreSightCoreComponent):
    ...
    def __init__(self):
        ...
        self.memory_map = memory_map.MemoryMap(
            memory_map.RamRegion(name="ram", start=0,
                                 length=0xf0000000, cacheable=True)
        )
...
class RomMemory(MemoryCache, MemoryInterface):
    ...
    def __init__(self, ranges):
        ...
        """
        super(RomMemory, self).__init__(
            MockDebugContext(), MockCoreForMemCache())
...
class MockCoreSight(RomMemory):
    ...
    def __init__(self, components):
        ...
        """
        ranges = {base: data for c in components for base,
                  data in c.data.items()}
...
class TestRomMemory:
    ...
    def test_rb8(self, testrom):
        ...
        assert testrom.read_memory_block8(
            0x4001, 6) == [0, 0, 0, 0xef, 0xbe, 00]
...
class TestRomTable:
    ...
    def test_m4_rom(self, m4_rom):
        ...
        cmpid = CoreSightComponentID(
            None, m4_rom, MockM4Components.M4_ROM_TABLE_BASE)
